...
<body>
   ...
   <div class="container">
      <div class="row">
         <ul class="ul">
            <button class="btn"><img src="./src/02.gif" alt=""></button>
            <!-- <li>box1</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/03.gif" alt=""></button>
            <!-- <li>box2</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/04.gif" alt=""></button>
            <!-- <li>box3</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/05.gif" alt=""></button>
            <!-- <li>box4</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/06.gif" alt=""></button>
            <!-- <li>box5</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/07.gif" alt=""></button>
            <!-- <li>box6</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/08.gif" alt=""></button>
            <!-- <li>box7</li> -->
         </ul>
         <ul class="ul">
            <button class="btn"><img src="./src/09.gif" alt=""></button>
            <!-- <li>box8</li> -->
         </ul>
      </div>
   ...
   <footer>
      <div>
         &copy;Copyright 2022 <a href="http://ntc.im/" target="_blank" style="color:blue"> NTC.im.</a> All rights reserved.
      </div>
   </footer>
   ...
   <script>
      ...
      $(document).ready(function () {
         ...
         // let n = 0;
         // var status = " ";
         // for (i = 0; i <= 7; i++) { // n=getRandom(8); // if (status.indexOf(n)> 0) {
         // i -= 1;
         // continue;
         // } else {
         // status += n + ' ';
         ...
         $(".btn").click(function () {
            ...
            function getRandom(x) {
               ...
               if (Math.floor(Math.random() * x) <= 2) {
                  ...
                  // return "c8763" } else if (Math.floor(Math.random() * x) <=4 && Math.floor(Math.random() * x)>= 2) {
                  $("h2").html(`彰化肉圓`)
